<div id="accordion-collapse" data-accordion="collapse" class="mb-10 w-5/6 mx-auto">
    ...
    <h2 id="accordion-collapse-heading-2">
        <button type="button"
            ...
            <span>Los Productos vienen con Diseño?</span>
            <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M9 5 5 1 1 5" />
        ...
        <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
            ...
            <ul class="ps-5 text-gray-500 list-disc dark:text-gray-400">
                <li><a href="https://flowbite.com/pro/"
                        class="text-blue-600 dark:text-blue-500 hover:underline">Porta Folio</a></li>
...
<?php /**PATH C:\xampp\htdocs\appfrangia.cl\resources\views/preguntas.blade.php ENDPATH**/ ?>