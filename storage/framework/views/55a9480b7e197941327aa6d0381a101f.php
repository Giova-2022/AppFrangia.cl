...
<?php $component->withAttributes([]); ?>
    ...
    <form class="w-11/12 mx-auto pt-44 mb-8">
        ...
        <div class="fondo__formulario  bg-gray-400 p-3 rounded-lg mt-3 w-full">
            ...
            <div class="grid grid-cols-4 p-2  bg-slate-500 rounded-lg sm:max-w-5/6">
                <div class="row-[1/4]">
                ...
                <div class="col-start-3 col-span-2" >
                        ...
                        class="h-8 col-start-2 col-span-2   1  mr-4 rounded-none rounded-l-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
...
<?php echo $__env->make('template.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\appfrangia.cl\resources\views/compra.blade.php ENDPATH**/ ?>